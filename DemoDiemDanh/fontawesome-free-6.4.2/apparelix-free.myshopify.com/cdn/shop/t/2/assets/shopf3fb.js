...
Line 168:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 169:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 795:4 Transforming const to the configured target environment ("es5") is not supported yet
Line 796:20 Transforming async functions to the configured target environment ("es5") is not supported yet
